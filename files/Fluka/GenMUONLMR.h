...
class GenMUONLMR  { 
 public:
  enum parttype_t {kPionLMR, kKaonLMR, kEtaLMR, kRhoLMR, kOmegaLMR, kPhiLMR, kEtaPrimeLMR, kJPsi};
  ...
  void SetYParams(Int_t iproc, Double_t p1, Double_t p2, Double_t p3, Double_t p4) {fY[iproc]->SetParameters(p1,p2,p3,p4);}
