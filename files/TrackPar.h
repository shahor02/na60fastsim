...
class TrackPar: public TObject {
 public:
  TrackPar();
  TrackPar(const TrackPar &);
  TrackPar& operator=(const TrackPar & trkPar);
  TrackPar(Double_t x, Double_t alpha, 
			const Double_t param[5], const Double_t covar[15]);
  TrackPar(Double_t xyz[3],Double_t pxpypz[3],
  ...
  Bool_t CorrectForMeanMaterial(Double_t xOverX0, Double_t xTimesRho, 
	...
	Double_t (*f)(Double_t)=TrackPar::BetheBlochSolid);
  ...
  Double_t GetPredictedChi2(const TrackPar *t) const;
  ...
  Double_t GetDCA(const TrackPar *p, Double_t b,
    Double_t &xthis,Double_t &xp) const;
  Double_t PropagateToDCA(TrackPar *p, Double_t b);
  ...
  Bool_t GetDistance(TrackPar *param2, Double_t x, Double_t dist[3], Double_t b);
  ...
  //-----------
  virtual Int_t GetTrackParam         ( TrackPar & ) const {return 0;}
  virtual Int_t GetTrackParamRefitted ( TrackPar & ) const {return 0;}
  virtual Int_t GetTrackParamIp       ( TrackPar & ) const {return 0;}
  virtual Int_t GetTrackParamTPCInner ( TrackPar & ) const {return 0;}
  virtual Int_t GetTrackParamOp       ( TrackPar & ) const {return 0;}
  virtual Int_t GetTrackParamCp       ( TrackPar & ) const {return 0;}
  virtual Int_t GetTrackParamITSOut   ( TrackPar & ) const {return 0;}
  //
...
inline void TrackPar::ResetCovariance(Double_t s2) {
  //
