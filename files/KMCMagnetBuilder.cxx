                                   ...
                                   float matRadL, float matDens, float defRadL, float defDens)
{
  ...
  float x2x0 = matRadL>0&&matDens>0 ? barSect/(8.897*matDens) : 0;
  ...
  pin120.poly[2].x = pin100.poly[3].x = 92.0; // fix edges
  ...
  auto pout11 = lrOut1->addPolygon(nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  ...
  auto pout21 = lrOut2->addPolygon(nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  ...
  auto pout31 = lrOut3->addPolygon(nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  ...
  auto pout41 = lrOut4->addPolygon(nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  ...
  auto pout51 = lrOut5->addPolygon(nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  ...
  auto pout61 = lrOut6->addPolygon(nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  ...
  auto pout71 = lrOut7->addPolygon(nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  ...
  auto pout80 = lrOut8->addPolygon( nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  lrOut8->setNSectorsPhiStart(nSectors, phi0);

  zl -= spacing + barSect;
  KMCPolyLayer* lrOut9 = det->AddPolyLayer("mag","magOut9", zl, defRadL, defDens, barSect);
  auto pout90 = lrOut9->addPolygon( nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  ...
  auto pout100 = lrOut10->addPolygon( nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  ...
  auto pout110 = lrOut11->addPolygon( nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  ...
  auto pout120 = lrOut12->addPolygon( nvCyan, dataCyan[0],dataCyan[1], x2x0, xrho);
  pout120.poly[0].x += 4*(spacing + barSect);
  pout120.poly[1].x += 4*(spacing + barSect);
  pout120.poly[2].x = pout100.poly[3].x = 92.0; // fix edges
